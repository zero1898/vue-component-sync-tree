(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('element-ui/lib/tree'), require('element-ui/lib/icon'), require('element-ui/lib/input'), require('element-ui/lib/button'), require('element-ui/lib/button-group')) :
	typeof define === 'function' && define.amd ? define(['element-ui/lib/tree', 'element-ui/lib/icon', 'element-ui/lib/input', 'element-ui/lib/button', 'element-ui/lib/button-group'], factory) :
	(global.vueComponentSyncTree = factory(global.ELEMENT.Tree,global.ELEMENT.Icon,global.ELEMENT.Input,global.ELEMENT.Button,global.ELEMENT.ButtonGroup));
}(this, (function (ELTree,ELIcon,ELInput,ELButton,ELButtonGroup) { 'use strict';

ELTree = ELTree && ELTree.hasOwnProperty('default') ? ELTree['default'] : ELTree;
ELIcon = ELIcon && ELIcon.hasOwnProperty('default') ? ELIcon['default'] : ELIcon;
ELInput = ELInput && ELInput.hasOwnProperty('default') ? ELInput['default'] : ELInput;
ELButton = ELButton && ELButton.hasOwnProperty('default') ? ELButton['default'] : ELButton;
ELButtonGroup = ELButtonGroup && ELButtonGroup.hasOwnProperty('default') ? ELButtonGroup['default'] : ELButtonGroup;
